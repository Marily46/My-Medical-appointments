...
public class UIPatientMenu {
    ...
    private  static void showBookAppointmentMenu() throws ParseException {
        ...
        do {
            ...
            int k = 0;
            for (int i = 0; i < UIDoctorMenu.doctorsAvailableAppoitments.size(); i++) {
                ArrayList<Doctor.AvailableAppointment> availableAppointments
                        = UIDoctorMenu.doctorsAvailableAppoitments.get(i).getAvailableAppointments();
                ...
                for (int j = 0; j < availableAppointments.size(); j++) {
                    ...
                    doctorAppointments.put(Integer.valueOf(j), UIDoctorMenu.doctorsAvailableAppoitments.get(i));

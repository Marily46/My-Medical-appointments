...
public class UIMenu {
    ...
    private static void authUser(int userType) throws ParseException {
        ...
        doctors.add(new Doctor("Marily", "marily45@mail.com"));
        doctors.add(new Doctor("Michel", "michel@mail.com"));
        doctors.add(new Doctor("ragnarbebe", "ragnar@mail.com"));

        ArrayList<Patient> patients = new ArrayList<>();
        patients.add(new Patient("geraldin", "geraldin@mail.com"));
        patients.add(new Patient("roberto", "robert@mail.com"));
        patients.add(new Patient("ana", "ana@mail.com"));

...
public class UIDoctorMenu {
    ...
    public static ArrayList<Doctor> doctorsAvailableAppoitments = new ArrayList<Doctor>();
    ...
    private static void checkDoctorAvailableAppointments(Doctor doctor){
        if (doctor.getAvailableAppointments().size() > 0
                && !doctorsAvailableAppoitments.contains(doctor)){
            doctorsAvailableAppoitments.add(doctor);
        }
    }
